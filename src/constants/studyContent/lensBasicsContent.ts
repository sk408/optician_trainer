...
export const lensBasicsContent: TopicStudyContent = {
  ...
  introduction: 'Ophthalmic lenses are precision optical devices that correct vision by compensating for refractive errors. Understanding lens types, materials, and designs is essential for any optician. This module covers fundamental concepts about prescription lenses that will serve as the foundation for more advanced topics.',
  objectives: [
      ...
      content: [
        {
          ...
          type: 'paragraph',
          content: {
            text: 'Ophthalmic lenses are classified according to their shape and optical properties. The most basic distinction is between convex (plus) and concave (minus) lenses, which correct different types of refractive errors.'
          }
        },
        {
          id: 'lens-types-image',
        ...
        },
        {
          ...
          content: {
            ...
            definition: 'Lenses with the same power in all meridians, used to correct myopia (minus spheres) or hyperopia (plus spheres).',
        ...
        },
        {
          ...
          content: {
            ...
            definition: 'Lenses that are thicker in the center than at the edges, used to correct hyperopia (farsightedness) and presbyopia.',
        ...
        },
        {
          ...
          content: {
            ...
            definition: 'Lenses that are thinner in the center than at the edges, used to correct myopia (nearsightedness).',
        ...
        },
        {
          ...
          content: {
            ...
            definition: 'Lenses with different powers in different meridians, used to correct astigmatism. Power varies from maximum to minimum across perpendicular meridians.',
        ...
        },
        {
          ...
          content: {
            ...
            definition: 'Combination lenses that have both spherical and cylindrical components, correcting both focus errors and astigmatism simultaneously.',
        ...
        },
        {
          ...
          content: {
            ...
            text: 'Lens power is measured in diopters (D), which indicate how strongly the lens converges or diverges light. Plus powers (+) converge light, while minus powers (-) diverge light. The higher the number, the stronger the lens power.'
          }
        }
      ]
    },
      ...
      content: [
        {
          ...
          type: 'paragraph',
          content: {
            text: 'Modern ophthalmic lenses are made from various materials, each with unique properties that affect weight, thickness, durability, and optical performance. Material selection is a critical decision when dispensing eyewear.'
          }
        },
        {
        ...
        },
        {
          ...
          content: {
            ...
            definition: 'A measure of how much a material bends light. Higher index materials create thinner lenses for the same prescription power.',
        ...
        },
        {
          ...
          content: {
            term: 'Abbe Value',
            definition: 'A measure of how much a lens material disperses light into its component colors. Higher values indicate less chromatic aberration (color fringing).',
        ...
        },
        {
          ...
          content: {
            ...
            definition: 'The density of a lens material relative to water, affecting the weight of the finished lens. Lower values create lighter lenses.',
        ...
        },
        {
          ...
          content: {
            ...
            text: 'For children and active adults, prioritize impact-resistant materials like polycarbonate or Trivex. For high prescriptions, consider high-index materials to reduce thickness and weight. For the best optical quality where thickness is less concern, CR-39 or Trivex may be preferred.'
          }
        }
      ]
    },
      ...
      content: [
        {
          ...
          type: 'paragraph',
          content: {
            text: 'Proper measurement of lenses is essential for accurate fabrication and fitting. Beginner opticians should understand the fundamental measurements used in lens dispensing.'
          }
        },
        {
